...
export default function LeadDetailPanel({
  ...
  return (
    <div
      className="fixed inset-0 backdrop-blur-sm bg-white/10 transition-all duration-300 flex justify-end z-60"
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-4 flex-grow overflow-y-auto pl-1">
          <div>
